    ...
    <v-dialog v-model="dialog" width="700px">
        ...
        <v-row class="justify-center">
          <v-col sm12 md12 lg8 class="justify-center">
            <div class="donation-text">
              <h2 class="history-title ufabcnext-primary--text">
                Ajude o UFABC Next
              </h2>
              <div class="history-text mt-3 mb-4">
                Que bom que temos você como nosso usuário 🥰🥳 <br /><br />
                O Next foi desenvolvido em 2019 <b>de alunos para alunos</b> e
                desde então é um projeto colaborativo 🤝 , onde você
                <a
      ...
      <v-card class="dialog-content">
        ...
        <v-card-text
          class="dialog-body"
          :style="{
            display: $vuetify.breakpoint.smAndDown ? 'block' : 'flex',
        ...
        >
          <div class="dialog-body-qrcode">
            <img
              ...
              :style="{
                width: $vuetify.breakpoint.smAndDown ? '200px' : '185px',
              }"
            />
          </div>
          <div
            ...
            :style="{
              marginLeft: $vuetify.breakpoint.smAndDown ? '10px' : '30px',
            }"
          >
            <p class="dialog-body-account-item">Nome: Felipe Oliveira Silva</p>
            <p class="dialog-body-account-item">
              Chave Pix (aleatória): <br /><b
                >4e031758-52fb-4c9c-876c-894dcaa6afe9</b
              >
            </p>
