      ...
      >
        ...
        <v-col class="mb-3">
          <section class="mb-3">
            ...
            <div class="createdAt-settings">Usuário desde {{ createdAt }}</div>
            <div>
              <a
                href="#"
              ...
              <a
                ...
                target="_blank"
                class="links-settings add-account ml-2"
                v-else-if="user"
              >
                <v-icon color="ufabcnext-blue" class="mr-2"
                  >mdi-plus-circle-outline</v-icon
    ...
    <v-dialog v-model="dialog" width="450px">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="green-darken-1" variant="text" @click="removeAccount()">
            Excluir conta
          </v-btn>
        </v-card-actions>
      </v-card>
...
const createdAt = computed(() => {
  return user.value?.createdAt.toLocaleDateString('pt-BR', { timeZone: 'UTC' });
});
// ------------------------------------------------------- //
