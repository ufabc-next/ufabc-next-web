<template>
  ...
  <div v-else>
    ...
    <PaperCard class="mt-4">
      ...
      <el-table empty-text="Nenhum dado encontrado" ref="disciplinas" v-loading="isLoadingCurrentInfo"
        :data="disciplinas" style="width: 100%">
...
import { getElapsedSeasons } from '@/utils/season';
import { getSeason } from '@/utils/season';
import { prettifySeason } from '@/utils/season';
